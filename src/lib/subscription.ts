...
export const PLANS = {
  ...
  basic: {
    ...
    price: 29,
    receipts_limit: 30,
    description: '30 recibos por mês',
    features: ['30 recibos por mês', 'Clientes ilimitados', 'Download em PDF', 'Suporte por email'],
    color: 'blue',
  },
  pro: {
    id: 'pro',
    ...
    price: 59,
    receipts_limit: 100,
    description: '100 recibos por mês',
    features: ['100 recibos por mês', 'Clientes ilimitados', 'Download em PDF', 'Suporte prioritário'],
    color: 'brand',
  },
  enterprise: {
    id: 'enterprise',
    ...
    features: ['Recibos ilimitados', 'Clientes ilimitados', 'Download em PDF', 'Suporte dedicado'],
    color: 'purple',
  },
}
